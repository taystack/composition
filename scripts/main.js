...
;(function(window, undefined) {
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define('../components/scripts/lodash/lodash',[],function() {
      return lodash;
    });
  }
...
define("underscore-string", (function (global) {
    return function () {
        var ret, fn;
        return ret || global._.str;
    };
}(this)));

// Generated by uRequire v0.2.9-3
define('underscore',['require', 'exports', 'module', '../components/scripts/lodash/lodash', 'underscore-string'], 
...
define("backbone-core", ["jquery","underscore","json2"], (function (global) {
    return function () {
        var ret, fn;
...
define("backbone-stickit", ["backbone-core"], function(){});

// Generated by uRequire v0.2.9-3
define('backbone',['require', 'exports', 'module', 'backbone-core', 'backbone-stickit'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
define('chaplin/application', ['backbone', 'chaplin/mediator', 'chaplin/dispatcher', 'chaplin/views/layout', 'chaplin/lib/router', 'chaplin/composer', 'chaplin/lib/event_broker'], function(Backbone, mediator, Dispatcher, Layout, Router, Composer, EventBroker) {
...
define('chaplin/composer', ['underscore', 'backbone', 'chaplin/lib/utils', 'chaplin/lib/event_broker'], function(_, Backbone, utils, EventBroker) {
  ...
  return Composer = (function() {
    ...
    Composer.prototype.perform = function(type, options) {
      var composition;
      composition = {
        params: options.params,
        view: new type(options)
      };
      if (!composition.view.autoRender) {
        composition.view.render();
      }
      return composition;
    };

    Composer.prototype.stale = function(composition, value) {
      var item, name;
    ...
    Composer.prototype.compose = function(name, type, options) {
      var composition,
        _this = this;
      if (options == null) {
        options = {};
      ...
      if (arguments.length === 3 || typeof type === 'function') {
        ...
        options.compose = function(options) {
          return _this.perform(type, options);
        };
      } else {
        options = type;
      }
      ...
      if (composition !== void 0 && options.check.call(composition, options.params)) {
        return this.stale(composition, false);
      } else {
        if (composition !== void 0) {
          this.destroy(composition);
        }
        return this.compositions[name] = options.compose(options.params);
      }
    };

    Composer.prototype.destroy = function(composition) {
      var item, name;
      for (name in composition) {
        item = composition[name];
        if (!(typeof (item != null ? item.dispose : void 0) === 'function')) {
          continue;
        }
        item.dispose();
    ...
    Composer.prototype.onStartupController = function(options) {
      var composition, name, _ref, _results;
      ...
      for (name in _ref) {
        ...
        if (composition.stale) {
          this.destroy(composition);
          _results.push(delete this.compositions[name]);
        } else {
          _results.push(this.stale(composition, true));
        }
      }
      return _results;
    };
...
define('chaplin/controllers/controller', ['underscore', 'backbone', 'chaplin/lib/event_broker'], function(_, Backbone, EventBroker) {
  ...
  return Controller = (function() {
    ...
    Controller.prototype.compose = function() {
      ...
      return this.publishEvent.apply(this, ['!composer:compose'].concat(__slice.call(params)));
    };
...
define('chaplin/views/layout', ['underscore', 'backbone', 'chaplin/lib/utils', 'chaplin/lib/event_broker'], function(_, Backbone, utils, EventBroker) {
  ...
  return Layout = (function() {
    ...
    Layout.prototype.registerRegionHandler = function() {
      var params;
      params = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (arguments.length === 1) {
        return this.registerRegions.apply(this, params);
      } else {
        return this.registerRegion.apply(this, params);
      }
    };
    ...
    Layout.prototype.registerRegions = function(instance) {
      var name, prototype, prototypeChain, selector, _i, _len, _ref, _results;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          var _ref1, _results1;
          _ref1 = prototype.regions;
          _results1 = [];
          for (selector in _ref1) {
            name = _ref1[selector];
            _results1.push(this.registerRegion(instance, name, selector));
          }
          return _results1;
        }).call(this));
      }
    ...
    Layout.prototype.unregisterRegionHandler = function() {
      var params;
      params = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (arguments.length === 1) {
        return this.unregisterRegions.apply(this, params);
      } else {
        return this.unregisterRegion.apply(this, params);
      }
    };

    Layout.prototype.unregisterRegion = function(instance, name) {
      return this.regions = _(this.regions).reject(function(region) {
        return region.instance.cid === instance.cid && region.name === name;
      });
    };
...
define('chaplin/views/view', ['underscore', 'backbone', 'chaplin/lib/utils', 'chaplin/lib/event_broker', 'chaplin/models/model', 'chaplin/models/collection'], function(_, Backbone, utils, EventBroker, Model, Collection) {
...
define('chaplin/views/collection_view', ['backbone', 'underscore', 'chaplin/views/view'], function(Backbone, _, View) {
...
define('chaplin', ['chaplin/application', 'chaplin/mediator', 'chaplin/dispatcher', 'chaplin/composer', 'chaplin/controllers/controller', 'chaplin/models/collection', 'chaplin/models/model', 'chaplin/views/layout', 'chaplin/views/view', 'chaplin/views/collection_view', 'chaplin/lib/route', 'chaplin/lib/router', 'chaplin/lib/delayer', 'chaplin/lib/event_broker', 'chaplin/lib/support', 'chaplin/lib/sync_machine', 'chaplin/lib/utils'], function(Application, mediator, Dispatcher, Composer, Controller, Collection, Model, Layout, View, CollectionView, Route, Router, Delayer, EventBroker, support, SyncMachine, utils) {
  return {
...
// Generated by uRequire v0.2.9-3
define('routes',['require','exports','module'],
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
module.exports = function(match) {
    ...
    return match("search/:id", "item#show", {
        name: "item"
    });
};
// uRequire: end body of original nodejs module
...
// Generated by uRequire v0.2.9-3
define('app',['require', 'exports', 'module', 'chaplin', './routes'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Application, Chaplin, routes, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
...
// Generated by uRequire v0.2.9-3
define('lib/views/view',['require', 'exports', 'module', 'underscore', 'chaplin'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Chaplin, View, _, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
module.exports = View = function(_super) {
    ...
    View.prototype._stuck = false;
    View.prototype.getTemplateFunction = function() {
        return this.template;
    };
    View.prototype.stickit = function() {
        View.__super__.stickit.apply(this, arguments);
        return this._stuck = true;
    };
    View.prototype.afterRender = function() {
...
// Generated by uRequire v0.2.9-3
define('lib/haml',['require', 'exports', 'module', 'underscore'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
(function() {
  ...
  define('templates/index',['lib/haml'], function(haml) {
    return function(context) {
      var render;
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='hero-unit'>\n<h1>Composition</h1>\n<p>\nThis is a simple application to demonstrate the power of Chaplin with\nthe composer.\n</p>\n<button class='btn btn-large btn-primary'>See more</button>\n</div>");
...
// Generated by uRequire v0.2.9-3
define('views/index',['require', 'exports', 'module', '../lib/views/view', 'templates/index'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Index, View, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
// Generated by uRequire v0.2.9-3
define('controllers/index',['require', 'exports', 'module', 'chaplin', '../views/index'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Chaplin, Index, View, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
// Generated by uRequire v0.2.9-3
define('lib/models/model',['require', 'exports', 'module', 'chaplin'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Chaplin, Model, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
module.exports = Model = function(_super) {
    ...
    Model.prototype.fetch = function(options) {
        ...
        this.beginSync();
        options.success = _.wrap(options.success, function() {
            var initial, params;
            initial = arguments[0], params = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
            if (initial != null) {
                initial.call.apply(initial, [ _this ].concat(__slice.call(params)));
            }
            return _this.finishSync();
        });
        options.error = _.wrap(options.error, function() {
            var initial, params;
            initial = arguments[0], params = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
            if (initial != null) {
                initial.call.apply(initial, [ _this ].concat(__slice.call(params)));
            }
            return _this.abortSync();
        });
...
// Generated by uRequire v0.2.9-3
define('models/item',['require', 'exports', 'module', '../lib/models/model'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Item, Model, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
module.exports = Item = function(_super) {
    ...
    Item.prototype.url = function() {
        return "http://www.omdbapi.com/?i=" + this.get("id");
    };
...
// Generated by uRequire v0.2.9-3
define('lib/collections/collection',['require', 'exports', 'module', 'underscore', 'chaplin'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Chaplin, Collection, _, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
// Generated by uRequire v0.2.9-3
define('collections/search',['require', 'exports', 'module', '../lib/collections/collection'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Collection, Search, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
module.exports = Search = function(_super) {
    ...
    Search.prototype.url = "http://www.omdbapi.com/";
...
(function() {
  ...
  define('templates/site',['lib/haml'], function(haml) {
    return function(context) {
      var render;
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='search-container'></div>\n<div class='content-container'></div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
// Generated by uRequire v0.2.9-3
define('views/site',['require', 'exports', 'module', '../lib/views/view', 'templates/site'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
module.exports = Index = function(_super) {
    ...
    Index.prototype.template = require("templates/site");
    Index.prototype.attributes = {
        id: "site"
    };
...
// Generated by uRequire v0.2.9-3
define('lib/views/collection_view',['require', 'exports', 'module', 'underscore', 'chaplin'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
module.exports = View = function(_super) {
    ...
    View.prototype.container = "#container";
    View.prototype._stuck = false;
    View.prototype.loadingSelector = ".loading";
    View.prototype.fallbackSelector = ".empty";
    View.prototype.getTemplateFunction = function() {
        return this.template;
    };
    View.prototype.stickit = function() {
...
(function() {
  ...
  define('templates/search/item',['lib/haml'], function(haml) {
    return function(context) {
      var render;
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='title'></div>\n<div class='year'></div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
(function() {
  ...
  define('templates/search',['lib/haml'], function(haml) {
    return function(context) {
      var render;
      render = function() {
        var $o;
        $o = [];
        $o.push("<input type='text' placeholder='Type here to search.'>\n<ul class='results'>\n<li class='loading'>Searching...</li>\n<li class='empty'>No results</li>\n</ul>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
// Generated by uRequire v0.2.9-3
define('views/search',['require', 'exports', 'module', '../lib/views/view', '../lib/views/collection_view', 'templates/search/item', 'templates/search'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var CollectionView, Item, Search, View, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
Item = function(_super) {
    ...
    Item.prototype.template = require("templates/search/item");
    Item.prototype.tagName = "li";
    Item.prototype.bindings = {
        ".title": "Title",
        ".year": "Year",
        ":el": {
            attributes: [ {
...
module.exports = Search = function(_super) {
    ...
    Search.prototype.template = require("templates/search");
    Search.prototype.itemView = Item;
    Search.prototype.attributes = {
        id: "search"
    };
    Search.prototype.listSelector = "ul.results";
    Search.prototype._request = null;
    Search.prototype._term = null;
    Search.prototype.events = {
        "keyup input": function(event) {
            ...
            if (term !== this._term && term !== "") {
                ...
                return this._request = this.collection.reset().fetch({
                    data: {
                        s: this._term
                    }
                });
        ...
        "click li": function(event) {
            ...
            id = el.data("id");
            return this.publishEvent("!router:routeByName", "item", [ id ]);
        }
    };
    return Search;
}(CollectionView);
...
// Generated by uRequire v0.2.9-3
define('controllers/search',['require', 'exports', 'module', 'chaplin', '../collections/search', '../views/site', '../views/search'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Chaplin, Collection, Search, View, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
module.exports = Search = function(_super) {
    ...
    Search.prototype.beforeAction = {
        ".*": function() {
            this.compose("site", View.Site);
            return this.compose("search", {
                compose: function() {
                    var composition;
                    composition = {
...
(function() {
  ...
  define('templates/item',['lib/haml'], function(haml) {
    return function(context) {
      var render;
      render = function() {
        var $o;
        $o = [];
        $o.push("<img class='img-polaroid poster'>\n<h2 class='title'></h2>\n<div class='name'>Rating</div>\n<div class='rating value'></div>\n<div class='name'>Rated</div>\n<div class='rated value'></div>\n<div class='name'>Genre</div>\n<div class='genre value'></div>\n<div class='name'>Director</div>\n<div class='director value'></div>\n<div class='name'>Released</div>\n<div class='released value'></div>\n<div class='name'>Plot</div>\n<div class='plot value'></div>");
        return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
      };
      return render.call(context);
    };
...
// Generated by uRequire v0.2.9-3
define('views/item',['require', 'exports', 'module', '../lib/views/view', 'templates/item'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
module.exports = Index = function(_super) {
    ...
    Index.prototype.template = require("templates/item");
    Index.prototype.attributes = {
        id: "item"
    };
    Index.prototype.bindings = {
        ".title": "Title",
        ".rating": "imdbRating",
        ".rated": "Rated",
        ".released": "Released",
        ...
        ".poster": {
            attributes: [ {
                name: "src",
                observe: "Poster",
                onGet: function(value, name) {
                    if (value === "N/A") {
                        return "http://www.americanhumanefilmtv.org/wp-content/uploads/2011/11/genericMoviePoster-202x300.jpg";
                    } else {
                        return value;
                    }
                }
...
// Generated by uRequire v0.2.9-3
define('controllers/item',['require', 'exports', 'module', '../models/item', './search', '../views/item'], 
  function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module


var Controller, Item, Model, View, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) {
        if (__hasProp.call(parent, key)) child[key] = parent[key];
    }
    function ctor() {
...
module.exports = Item = function(_super) {
    ...
    Item.prototype.show = function(options) {
